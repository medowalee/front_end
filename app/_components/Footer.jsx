  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    ...
    >
      ...
      <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
        <li>
          <a
            href="https://www.facebook.com/profile.php?id=61552373455979"
            rel="noreferrer"
            target="_blank"
        ...
        <li>
          <a
            href="https://www.instagram.com/mohamad__gared/"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75 dark:text-gray-200"
          >
        ...
        <li>
          <a
            href="https://x.com/medowaleedmagde"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75 dark:text-gray-200"
          >
        ...
        <li>
          <a
            href="https://github.com/medowalee"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75 dark:text-gray-200"
          >
        ...
        <li>
          <a
            href="https://discord.gg/rujsQAVbGF"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75 dark:text-gray-200"
          >
